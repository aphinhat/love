...
ki = LINETCR.LINE() 
ki.login(token="EnydCP24zvUD86xELcz5.FBEDyFR5gI1sGHBi8U9K1q.0oMljTiA9qcdfXg2740oypXnK5M0jDUtP0ghqvlULtA=")
ki.loginResult()

ki2 = LINETCR.LINE() 
ki2.login(token="EnsS4o0fBycRESVdp8Yb.NTVWiuyYJuMNlDtFVCG+QW.iNbcPoSI1Sv2a7udu9bwQWpmYeq2J2A+GYjFoQXwnR8=")
ki2.loginResult()

ki3 = LINETCR.LINE() 
ki3.login(token="Enuz5E36YbQ1hhdnzbj8.8FRzYnw1IupIiax/jwFyga.KrYZuE6MgUjYX2R/6GEx5cWcEMi8cOowkS1a3c8M6kk=")
ki3.loginResult()

ki4 = LINETCR.LINE() 
ki4.login(token="EnPlTSYwrsXJMx2nERxe.IsNTPVMfVlhDIQm0VAJTNG.GJ9a31+QC6M6NY+zRBbfTW3TNbKkQrGuV4Jy5SueNz0=")
ki4.loginResult()

ki5 = LINETCR.LINE() 
ki5.login(token="EnchfozZJNbBTVCJwoO8.mSh2gA5OmkpJcdfuY+A7/a.K2vmPs5j3170G45S1RBmqFjh1MyvAdT7jgYcYNCLkjY=")
ki5.loginResult()

ki6 = LINETCR.LINE() 
ki6.login(token="EnNAeDVGiCy5hvA458A8.tmAfvdmDPZO5xo5uyqY46a.E1Mj5s9Azyacw8fKBirUuGR4nK0MXJ6u1ut13iRkcMc=")
ki6.loginResult()
...
wait = {
    ...
    'autoAdd':True,
    'message':"""THX FOR ADD : 
🐺 แอดมารักรึแอดมารันรึมึงจะเอาไอ้สัส
""",
    "lang":"JP",
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "ubcce77ee1567e766abdf17a66d9472f1":
                    if "join:" in msg.text:
...
#--------------------------------------------------------
                ...
                if wait["linkprotect"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"It is already On ô€¨")
            elif msg.text in ['ยกเลิกเชินเปิด']:
                ...
                if wait["linkprotect"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"It is already open ô€œ👈")
            elif msg.text in ["ยกเลิกเชินปิด"]:
...
#-------------Fungsi Tagall User Start---------------#
            elif msg.text in ["แทค","dor","Ngntd","ngntd","Cum","cum"]:
                group = cl.getGroup(msg.to)
